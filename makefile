...
ifneq ($(filter android dragonfly freebsd linux netbsd openbsd solaris,$(TARGET_OS)),)
...
ifneq ($(filter android darwin dragonfly freebsd linux netbsd openbsd solaris,$(TARGET_OS)),)
